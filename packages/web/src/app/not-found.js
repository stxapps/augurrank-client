...
export default function NotFound() {
  return (
    <div style={{ minHeight: 'calc(100vh - 3.75rem - 6.5rem)' }} className="mx-auto relative flex max-w-2xl flex-col items-center justify-center px-4 sm:px-6 lg:px-8 xl:px-12 text-center">
