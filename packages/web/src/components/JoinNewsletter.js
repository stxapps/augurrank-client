...
const STATUS_INIT = JOIN_NEWSLETTER_STATUS_INIT;
const STATUS_JOINING = JOIN_NEWSLETTER_STATUS_JOINING;
const STATUS_INVALID = JOIN_NEWSLETTER_STATUS_INVALID;
const STATUS_COMMIT = JOIN_NEWSLETTER_STATUS_COMMIT;
const STATUS_ROLLBACK = JOIN_NEWSLETTER_STATUS_ROLLBACK;
...
export function JoinNewsletter() {
  const state = useSelector(state => state.joinNewsletter);
